...
import com.focustech.android.lib.page.BuildConfigUtil;
...
import static com.focustech.android.lib.page.BuildConfigUtil.APP_WORK_DIR;
...
public class FileUtil {
     ...
     * @return
     */
    public static String getOemAppWorkPath(Context context) {
        // 判断sdcard是否存在
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            // 获取根目录
            return Environment.getExternalStorageDirectory().getPath() + File.separator + BuildConfigUtil.getBuildConfigValue(context,APP_WORK_DIR);
        }
        return context.getFilesDir().getPath();
    }
